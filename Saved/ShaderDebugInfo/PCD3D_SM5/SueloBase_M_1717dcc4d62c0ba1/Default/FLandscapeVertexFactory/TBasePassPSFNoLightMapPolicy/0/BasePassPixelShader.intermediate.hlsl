...
void frag_main()
{
    ...
    float3 _348 = clamp(((lerp(-2000.0f, 2000.0f, Material_Texture2D_4.SampleBias(Material_Texture2D_4Sampler, _285, View_View_MaterialTextureMipBias).z) + _315) - 1000.0f) * 0.0005000000237487256526947021484375f, 0.0f, 1.0f).xxx;
